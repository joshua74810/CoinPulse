...
const DataTable = <T,>({
  ...
  <TableHeader className ={headerClassName}>
    ...
    {columns.map((column, index) => (
        <TableHead key={index} className={cn('bg-dark-400',
            'text-purple-1000 py-4 first:pl-5 last:pr-5',
  ...
  <TableBody>
     {data.map((row, rowIndex) => (
        ...
        (`overflow-hidden rounded-lg border-b 
        border-purple-100/5 hover:bg-dark-400/30
         relative`, bodyRowClassName)}> 
